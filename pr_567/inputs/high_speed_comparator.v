...
diffpair mmn0_mmn1 ( .vcom(vcom), .vin(vin), .vin_d(vin_d), .vip(vip), .vip_d(vip_d) ); 
ccn mmn4_mmn3 ( .vin_d(vin_d), .vin_o(vin_o), .vip_d(vip_d), .vip_o(vip_o) ); 
ccp mmp1_mmp0 ( .vin_o(vin_o), .vip_o(vip_o) ); 
INV mmn5_mmp6 ( .i(vin_o), .zn(von) ); 
INV mmn6_mmp7 ( .i(vip_o), .zn(vop) ); 

endmodule

module diffpair ( vcom, vin, vin_d, vip, vip_d ); 
input vcom, vin, vin_d, vip, vip_d;

DP_NMOS_B_nfin12_m16_n12_X8_Y2 mmn1_mmn0 ( .B(vss), .DA(vip_d), .DB(vin_d), .GA(vip), .GB(vin), .S(vcom) ); 

endmodule

module ccn ( vin_d, vin_o, vip_d, vip_o ); 
input vin_d, vin_o, vip_d, vip_o;

CCP_S_NMOS_B_nfin12_m8_n12_X8_Y1 mmn4_mmn3 ( .B(vss), .DA(vin_o), .DB(vip_o), .SA(vin_d), .SB(vip_d) ); 

endmodule

module ccp ( vin_o, vip_o ); 
input vin_o, vip_o;
